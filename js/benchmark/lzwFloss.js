/*
* Title: lzwFloss
* Description: Multithreaded lzw implementation
...
*/
function lzwEncode(inputString, onSuccess) {
...
* @param {function} onSuccess
*/
function lzwDecode(inputString, onSuccess) {
...
* @param {function} onSuccess
*/
function run(inputString, fn, onSuccess, decode) {
...
* @param {string} inputString
*/
function splitString(inputString, onSuccess) {
